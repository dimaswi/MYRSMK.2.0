            ...
            <div class="grid gap-4 sm:grid-cols-5 sm:gap-6 mt-4">
                <div class="w-full">
                    ...
                    <select wire:model="jam_kerja"
                        ...
                        @foreach ($jadwal_manajemens as $value)
            ...
            <div class="grid gap-4 sm:grid-cols-5 sm:gap-6 mt-4">
                <div class="w-full">
                    ...
                    <select wire:model="jam_kerja"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option value="">Pilih Jam Kerja</option>
                            @foreach ($jadwal_siangs as $value)
                                <option value="{{ $value->jam_kerja }}">{{ $value->jam_kerja }}</option>
                            @endforeach
                    </select>
                    @error('jam_kerja')
            ...
            <div class="grid gap-4 sm:grid-cols-5 sm:gap-6 mt-4">
                <div class="w-full">
                    ...
                    <select wire:model="jam_kerja"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option value="">Pilih Jam Kerja</option>
                            @foreach ($jadwal_malams as $value)
                                <option value="{{ $value->jam_kerja }}">{{ $value->jam_kerja }}</option>
                            @endforeach
                    </select>
                    @error('jam_kerja')
