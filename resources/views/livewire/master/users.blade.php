                            ...
                            <div
                                ...
                                <div x-cloak x-show="modelOpen"
                                    ...
                                    <div class="flex items-center justify-between space-x-4">
                                        ...
                                        <h1 class="text-xl font-medium text-gray-800 ">Tambah User Baru</h1>
                                    ...
                                    <form class="mt-5" wire:submit.prevent="save">
                                        ...
                                        <div class="mt-4">
                                            <label for=""
                                                class="block text-sm text-gray-700 capitalize dark:text-gray-200">Handphone</label>
                                            <input wire:model="phone" placeholder="Masukan Handphone" type="number"
                                                class="block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40">
                                            @error('phone')
                                                <span class="text-red-300">{{ $message }}</span>
                                            @enderror
